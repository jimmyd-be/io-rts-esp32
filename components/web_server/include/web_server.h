...
static inline void web_server_broadcast_position(const char *id, int pos, bool s, bool e) { (void)id; (void)pos; (void)s; (void)e; }
...
static inline void pair_log_append(const char *e) { (void)e; }
#endif
